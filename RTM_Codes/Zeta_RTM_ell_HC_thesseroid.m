...
sin_lat_o=sin(lat_o_tesseroide); cos_lat_o=cos(lat_o_tesseroide); sin_long_o=sin(long_o_tesseroide);
cos_long_o=cos(long_o_tesseroide); sin_dlong=sin_long_o.*cos_long-cos_long_o.*sin_long; cos_dlong=cos_long_o.*cos_long+sin_long_o.*sin_long;
...
Eta_RTM_tesseroide=sum(V_tesseroide,"omitnan")./gama+Eta_RTM_HC_Omang   % m
toc

% dg por fatias de raios para geração de gráfico
Eta_RTM_tesseroide_raios=zeros(1,radius_metros/1000);
...
V_grafico=V_tesseroide.*index;    %m2/s2
Eta_RTM_tesseroide_raios(1,i)=sum(V_grafico,"omitnan")./gama+Eta_RTM_HC_Omang;   % m
...
% figure(1);
% plot(radius_grafico,Eta_RTM_tesseroide_raios);
...
Eta_RTM_tesseroide_raios=Eta_RTM_tesseroide_raios';